...
from MNIST_nn_methods import nn_SGD, nn_averg_SGD, FedGate, Plotter, Plotter2, FedNova
import math
import random
import pickle

n_nodes, active_nodes = 20, 1
n_trainset, n_testset = 50000, 10000
b_size_SGD, b_size_averg_SGD, b_size_FedGate = 100, 100, 100
eta_SGD, eta_averg_SGD, eta_FedGate = 0.005, 0.05, 0.05
epochs_SGD, epochs_averg_SGD, epochs_FedGate = 15, 81, 81
...
pickle.dump(returning_values_FedAvg, open("CIFAR10_nn_FedAvg_last5.dat", "wb"))
#input("Stop after returning")
...
pickle.dump(returning_values_FedNova, open("CIFAR10_nn_FedNova_last5.dat", "wb"))
#input("Stop after returning")
...
pickle.dump(returning_values_FedGate_Doubling, open("CIFAR10_nn_Doubling_last5.dat", "wb"))
#input("Stop here")
...
pickle.dump(returning_values_FedGate_Allnodes, open("CIFAR10_nn_Allnodes_last5.dat", "wb"))
#input("Stop here")
Plotter2()

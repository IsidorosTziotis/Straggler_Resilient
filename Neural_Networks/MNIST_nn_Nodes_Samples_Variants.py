...
epochs_SGD, epochs_averg_SGD, epochs_FedGate = 15, 140, 140
...
#Increasing the number of nodes 10 times
n_nodes = 200
b_size_SGD, b_size_averg_SGD, b_size_FedGate = 10, 10, 10 #Making batch size 10 times smaller
...
"""
#Dropping 90% of the data at random
temp_set, currentset = torch.utils.data.random_split(currentset, [54000, 6000])
n_trainset = 6000
b_size_SGD, b_size_averg_SGD, b_size_FedGate = 10, 10, 10 #Making batch size 10 times smaller
"""
...
pickle.dump(returning_values_FedGate_Doubling, open("MNIST_nn_Doubling_last_many_nodes2.dat", "wb"))
#input("Stop here")
...
pickle.dump(returning_values_FedGate_Allnodes, open("MNIST_nn_Allnodes_last_many_nodes2.dat", "wb"))
#input("Stop here")
Plotter()
